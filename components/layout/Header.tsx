        ...
        <header className="h-20 bg-leather border-b-[6px] border-[#3e2723] shadow-[0_10px_20px_rgba(0,0,0,0.5)] flex items-center px-6 justify-between z-50 relative no-print shrink-0">
            ...
            <div className="flex items-center gap-6">
                ...
                <button
                    ...
                    className="w-10 h-10 skeuo-glass-btn glass-amber group"
                    title="英语学习闭环 (Workflow)"
                >
                    <svg className="w-5 h-5 text-[#3e2723] opacity-80 z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                    ...
                    className="w-10 h-10 skeuo-glass-btn glass-steel group"
                    title="关于 / 设置 (System)"
                >
                    <svg className="w-5 h-5 text-[#263238] opacity-80 z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
